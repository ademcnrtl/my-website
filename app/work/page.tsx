...
const projects: Project[] = [
  ...
  },
  {
    id: 1,
    title: "Nightlog",
    subtitle: "Astrophotography companion app.",
    type: "Software",
    year: "2024",
    tags: ["Next.js", "TypeScript", "Supabase"],
    description: "Log sessions. Track weather windows. Plan compositions. Built because nothing out there understood what a night shooter actually needs.",
  ...
  },
  {
    id: 4,
    title: "Lucid Systems",
    subtitle: "Brand identity for a UX research consultancy.",
    type: "Design",
    year: "2023",
    tags: ["Brand", "Web", "Strategy"],
    description: "Positioning and visual identity. The challenge: make rigorous thinking feel human and approachable.",
    role: "Designer",
    status: "Agency",
  },
];
